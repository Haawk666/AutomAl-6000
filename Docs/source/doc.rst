...
graph operations from the **column_characterization** module. The
...
The function-module **utils** is a collection of simple functions which are
used by varying modules throughout the program, wherever it is convenient.
